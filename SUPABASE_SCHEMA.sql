-- ImmoGest CI - Schéma de base de données Supabase
...
-- Données d'exemple (optionnel - vous pouvez les supprimer après les tests)
...
-- Activer la sécurité au niveau des lignes (RLS) - optionnel
...
-- Politiques RLS basiques (vous pouvez les personnaliser selon vos besoins)
-- Pour permettre la lecture à tous les utilisateurs authentifiés
CREATE POLICY "Allow read access" ON properties FOR SELECT USING (true);
CREATE POLICY "Allow read access" ON units FOR SELECT USING (true);
CREATE POLICY "Allow read access" ON tenants FOR SELECT USING (true);
CREATE POLICY "Allow read access" ON maintenance_requests FOR SELECT USING (true);
CREATE POLICY "Allow read access" ON transactions FOR SELECT USING (true);

-- Pour permettre l'écriture à tous les utilisateurs authentifiés (à personnaliser selon vos besoins)
CREATE POLICY "Allow insert access" ON properties FOR INSERT WITH CHECK (true);
CREATE POLICY "Allow insert access" ON units FOR INSERT WITH CHECK (true);
CREATE POLICY "Allow insert access" ON tenants FOR INSERT WITH CHECK (true);
CREATE POLICY "Allow insert access" ON maintenance_requests FOR INSERT WITH CHECK (true);
CREATE POLICY "Allow insert access" ON transactions FOR INSERT WITH CHECK (true);

CREATE POLICY "Allow update access" ON properties FOR UPDATE USING (true);
CREATE POLICY "Allow update access" ON units FOR UPDATE USING (true);
CREATE POLICY "Allow update access" ON tenants FOR UPDATE USING (true);
CREATE POLICY "Allow update access" ON maintenance_requests FOR UPDATE USING (true);
CREATE POLICY "Allow update access" ON transactions FOR UPDATE USING (true);

CREATE POLICY "Allow delete access" ON properties FOR DELETE USING (true);
CREATE POLICY "Allow delete access" ON units FOR DELETE USING (true);
CREATE POLICY "Allow delete access" ON tenants FOR DELETE USING (true);
CREATE POLICY "Allow delete access" ON maintenance_requests FOR DELETE USING (true);
CREATE POLICY "Allow delete access" ON transactions FOR DELETE USING (true);