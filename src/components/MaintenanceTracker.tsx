...
export function MaintenanceTracker() {
  ...
  const handleAddRequest = () => {
    if (!newRequestForm.title || !newRequestForm.unit || !newRequestForm.category || !newRequestForm.priority) {
    ...
    const newRequest: MaintenanceRequest = {
      ...
      reportedBy: newRequestForm.reportedBy || "Propriétaire",
      estimatedCost: newRequestForm.estimatedCost ? parseInt(newRequestForm.estimatedCost) : undefined
    };
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Select value={newRequestForm.unit} onValueChange={(value) => setNewRequestForm(prev => ({ ...prev, unit: value }))}>
                    <SelectTrigger>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="3A">Logement 3A</SelectItem>
                      <SelectItem value="3B">Logement 3B</SelectItem>
                      <SelectItem value="4A">Logement 4A</SelectItem>
                      <SelectItem value="4B">Logement 4B</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Select value={newRequestForm.category} onValueChange={(value) => setNewRequestForm(prev => ({ ...prev, category: value }))}>
                    <SelectTrigger>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input 
                    ...
                    value={newRequestForm.reportedBy}
                    onChange={(e) => setNewRequestForm(prev => ({ ...prev, reportedBy: e.target.value }))}
                  />
                </div>
                <div>
                  ...
                  <Input 
                    id="estimatedCost" 
                    type="number" 
                    placeholder="Entrer le coût estimé"
                    value={newRequestForm.estimatedCost}
                    onChange={(e) => setNewRequestForm(prev => ({ ...prev, estimatedCost: e.target.value }))}
                  />
                </div>
              </div>
              <div className="flex justify-end space-x-2">
                <Button variant="outline" onClick={() => setNewRequestForm({
                  title: "",
                  description: "",
                  unit: "",
                  category: "",
                ...
                <Button onClick={handleAddRequest}>Créer Demande</Button>
              </div>
            </div>
          </DialogContent>
        </Dialog>
